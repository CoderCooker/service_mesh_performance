...
//         def uuid1 = Math.abs(new Random().nextInt() % 45000) + 1
//         sh('''/home/centos/workspace/scale_client_clusters/kind create cluster --name slave-1-5-cls-'''+ uuid1 +''' --config /home/centos/workspace/scale_client_clusters/kind.config''')

//         def uuid2 = Math.abs(new Random().nextInt() % 45000) + 1
//         sh('''/home/centos/workspace/scale_client_clusters/kind create cluster --name slave-1-5-cls-'''+ uuid2 + ''' --config /home/centos/workspace/scale_client_clusters/kind.config''')
