...
//         ''')
        ...
        // sh('''/home/centos/workspace/scale_client_clusters/kind create cluster --name cls515-'''+ uuid1 +''' --config /home/centos/workspace/scale_client_clusters/kind.config''')

        // def uuid2 = Math.abs(new Random().nextInt() % 50000000) + 1
        // sh('''/home/centos/workspace/scale_client_clusters/kind create cluster --name cls515-'''+ uuid2 + ''' --config /home/centos/workspace/scale_client_clusters/kind.config''')
